...
<form method ="post" action="../{{$cliente->id}}">
    ...
    <tr>
        <td>Foto:</td>    
        <td><img src="images/{{$cliente->ruta}}"width="20"/></td><br>
        
    </tr>
   <!-- <tr>
       <td><h3>Cambiar:<span><input type="file" name="file" required="yes"
       oninvalid="this.setCustomValidity('Ingrese un archivo')" oninput="this.setCustomValidity('')"/></span></h3></td>
    </tr>-->
